...
function SignIn() {
    const [credentials, setCredentials] = useState<User>({ _id: "",username: "", password: "", email: "", following: [], followers: [], role: "USER"});
    const navigate = useNavigate();
    const dispatch = useDispatch();
    const signin = async () => {
        const currentUser = await client.signin(credentials);
        dispatch(setCurrentUser(currentUser));
        navigate(`/MustardMatrix/Profile/`);
    };
    return (
        <div className="p-4 ">
            <h1>Sign In</h1>
            ...
            <div className="p-2">
                <div className="row">
                    ...
                    <div className="col-sm-9 col-md-10 col-lg-11">
                        <input id="sign-in-username" type="text" style={{ maxWidth: '300px' }} placeholder=""
                ...
                <div className="row">
                    ...
                    <div className="col-sm-9 col-md-10 col-lg-11">
                        <input id="sign-in-password" type="password" style={{ maxWidth: '300px' }} placeholder=""
                ...
                <div className="row">
                    <div className="offset-sm-3 offset-md-2 offset-lg-1">
                        ...
                        <button className="btn btn-light mt-3 me-3 mb-3" onClick={() => navigate("/MustardMatrix/SignUp")}>Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
